...
public class TeleportTraining extends Teleporting {
	...
	public static enum Training {
		TELEPORT_1(new String[] {"@gr3@zirconis",""}, new int[] {2305, 4589, 0}, 0),
		TELEPORT_2(new String[] {"@mag@Artillery", ""}, new int[] {1839,5087,2},0),
		TELEPORT_3(new String[] {"@bla@Skiadrum", ""}, new int[] {3561, 9948,0},0),
		TELEPORT_4(new String[] {"@whi@weisslogia", ""}, new int[] {3169, 2982, 0},0),
		TELEPORT_5(new String[] {"@or3@Allan", ""}, new int[] {2793, 2773, 0},0),
		TELEPORT_6(new String[] {"@eyl@Aurelia", ""}, new int[] {1747,5323,0},0),
		TELEPORT_7(new String[] {"@red@Belerion", ""}, new int[] {2704,9756,0},0),
		TELEPORT_8(new String[] {"@cya@Livyathann", ""}, new int[] {2908,9803,0},0),
