...
public class HarLakkRiftsplitter implements CombatStrategy {
	 ...
	 * Animations
	 */
	public Animation meleeHit = new Animation(10922);
	public Animation hugeMelee = new Animation(10918);
	public Animation handClap = new Animation(10922);
	public Animation mageMelee = new Animation(10918);
