...
import com.ruse.world.content.skill.impl.herblore.IngridientsBook;
...
public class ButtonClickPacketListener implements PacketListener {
	...
	public void handleMessage(Player player, Packet packet) {
		...
		case 11014:
			...
			break;
		case -26333:
			player.getPacketSender().sendString(1, "www.Ruseps.com/forums/");
			player.getPacketSender().sendMessage("Attempting to open: Ruseps.com/forums");
			break;
		case -26332:
			player.getPacketSender().sendString(1, "http://Ruseps.com/rules");
			player.getPacketSender().sendMessage("Attempting to open: Ruseps.com/rules");
			break;
		case -26331:
			player.getPacketSender().sendString(1, "www.Ruseps.com/store/");
			player.getPacketSender().sendMessage("Attempting to open: Ruseps.com/store");
			break;
		case -26330:
			player.getPacketSender().sendString(1, "www.Ruseps.com/vote/");
			player.getPacketSender().sendMessage("Attempting to open: Ruseps.com/vote");
			break;
		case -26329:
			player.getPacketSender().sendString(1, "www.Ruseps.com/hiscores/");
			player.getPacketSender().sendMessage("Attempting to open: Ruseps.com/hiscores");
			break;
		case -26328:
			player.getPacketSender().sendString(1, "www.Ruseps.com/forums/index.php?/forum/27-report-a-player/");
			player.getPacketSender().sendMessage("Attempting to open: Ruseps.com/report");
			break;
		case -26335:
