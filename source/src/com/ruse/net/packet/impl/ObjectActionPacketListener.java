			...
			public void execute() {
				...
				case 5262:
					if(player.getLocation() == Location.KRAKEN) {
						player.getPacketSender().sendMessage("You leave the cave and end up in Edgeville..");
				...
				case 26427:
					...
					if(!leaveRoom && (player.getAmountDonated() < 50 && player.getMinigameAttributes().getGodwarsDungeonAttributes().getKillcount()[index] < 20)) {
