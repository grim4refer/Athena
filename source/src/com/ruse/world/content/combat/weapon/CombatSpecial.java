...
public enum CombatSpecial {
	...
	DRAGON_DAGGER(new int[] { 1215, 1231, 5680, 5698, 13047, 13049 }, 25, 1.16, 1.20, CombatType.MELEE, WeaponInterface.DAGGER) {
		@Override
	...
	ABYSSAL_WHIP(new int[] { 4151, 21371, 15441, 15442, 15443, 15444 }, 50, 1, 1, CombatType.MELEE, WeaponInterface.WHIP) {
		@Override
		public CombatContainer container(Player player, Character target) {
	...
	ABYSSAL_BLUDGEON(new int[] { 13045 }, 50, 1.21, 1.30, CombatType.MELEE, WeaponInterface.WARHAMMER) {
		@Override
		public CombatContainer container(Player player, Character target) {
	...
	DRAGON_WARHAMMER(new int[] { 20555 }, 30, 1.45, 1.40, CombatType.MELEE, WeaponInterface.WARHAMMER) {
		@Override
		public CombatContainer container(Player player, Character target) {
