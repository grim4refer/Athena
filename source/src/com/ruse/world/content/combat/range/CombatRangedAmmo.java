...
public class CombatRangedAmmo {
	...
	public enum RangedWeaponData {
		TOXIC_BLOWPIPE(new int[] {22047}, new AmmunitionData[] {AmmunitionData.BLOWPIPE}, RangedWeaponType.BLOWPIPE),
		//TOXIC_BLOWPIPE(new int[] {22047}, new AmmunitionData[] {AmmunitionData.BRONZE_ARROW, AmmunitionData.IRON_ARROW, AmmunitionData.STEEL_ARROW, AmmunitionData.MITHRIL_ARROW, AmmunitionData.ADAMANT_ARROW, AmmunitionData.RUNE_ARROW, AmmunitionData.ICE_ARROW, AmmunitionData.BROAD_ARROW}, RangedWeaponType.SHORTBOW),
		...
		//TOXIC_BLOWPIPE(new int[]{22047}, new AmmunitionData[] {AmmunitionData.ZULRAH_SCALES}, RangedWeaponType.BLOWPIPE);
	...
	public enum AmmunitionData {
		...
		BLOWPIPE(new int[] {22047}, /*1123*/-1, 226, 4, 33, 25, 49, 37),
