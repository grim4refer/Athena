...
public enum SlayerTasks {
	...
	ORK(SlayerMaster.DURADEL, 6273, "Orks can be found in the Godwars Dungeon.", 7600, new Position(2867, 5322, 2)),
	...
	TORMENTED_DEMON(SlayerMaster.SUMONA, 8349, "Tormented Demons can be found using the Boss teleport.", 40000, new Position(2717, 9805)),
	KING_BLACK_DRAGON(SlayerMaster.SUMONA, 50, "The King Black Dragon can be found using the Boss teleport.", 26000, new Position(2273, 4681)),
	...
	CALLISTO(SlayerMaster.SUMONA, 2009, "Callisto can be found using the Boss teleport.", 57544, new Position(3163, 3796)),
	VETION(SlayerMaster.SUMONA, 2006, "Vet'ion can be found using the Boss teleport.", 61560, new Position(3009, 3767)),
	VENENATIS(SlayerMaster.SUMONA, 2000, "Venenatis can be found using the Boss teleport.", 59233, new Position(3005, 3732)),
	SCORPIA(SlayerMaster.SUMONA, 2001, "Scorpia can be found using the Boss teleport.", 60500, new Position(2849, 9640)),
	;
