...
public class PointsHandler {
	...
	public PointsHandler refreshPanel() {
		...
		p.getPacketSender().sendString(39182, "@or2@Barrows Points: @yel@"+barrowsPoints);
		p.getPacketSender().sendString(39183, "@or2@Member Points: @yel@"+memberPoints);
		p.getPacketSender().sendString(39184, "@or2@Pk Points: @yel@"+pkPoints);
		p.getPacketSender().sendString(39185, "@or2@Wilderness Killstreak: @yel@"+p.getPlayerKillingAttributes().getPlayerKillStreak());
		p.getPacketSender().sendString(39186, "@or2@Wilderness Kills: @yel@"+p.getPlayerKillingAttributes().getPlayerKills());		
		p.getPacketSender().sendString(39187, "@or2@Wilderness Deaths: @yel@"+p.getPlayerKillingAttributes().getPlayerDeaths());
		p.getPacketSender().sendString(39188, "@or2@Arena Victories: @yel@"+p.getDueling().arenaStats[0]);
		p.getPacketSender().sendString(39189, "@or2@Arena Losses: @yel@"+p.getDueling().arenaStats[1]);
		return this;
	}
