	...
	public static Dialogue get(Player p, int stage) {
		...
		case -2:
			dialogue = new Dialogue() {
				...
				public String[] dialogue() {
					return new String[]{"That mode will suite you well.",
							"FILL THIS IN ICEY", 
							"FILL THIS IN ICEY"};
				};
		...
		case -1:
			dialogue = new Dialogue() {
				...
				@Override
				public String[] dialogue() {
					return new String[]{"Chaotic longsword", "Chaotic rapier", "Chaotic maul", "Chaotic crossbow", "Chaotic staff"};
				};
		...
		case 0:
			dialogue = new Dialogue() {
				...
				@Override
				public String[] dialogue() {
					return new String[]{"So let's get you started out,", "shall we? I'll give you a few tips and once you've finished", "you'll be ready to go.", "Let's start with the most important aspect; money!"};
				};
		...
		case 1:
			dialogue = new Dialogue() {
				...
				@Override
				public String[] dialogue() {
					return new String[]{"You can earn money doing many different things in", "Ruse. For example, see those Thieving stalls infront of ", "you? You can steal items from them and sell them to the", "merchant whose standing over there."};
				};
		...
		case 6:
			dialogue = new Dialogue() {
				...
				@Override
				public String[] dialogue() {
					return new String[]{"Enough of the boring stuff, let's show you some creatures!", "There are a bunch of bosses to fight in Ruse.", "Every boss drops unique and good gear when killed.", "One example is the mighty Pohenix!"};
				};
		...
		case 8:
			dialogue = new Dialogue() {
				...
				@Override
				public String[] dialogue() {
					return new String[]{"Ruse also has a lot of enjoyable minigames.", "This is the Graveyard Arena, an area that's been run over", "by Zombies. Your job is to simply to kill them all.", "Sounds like fun, don't you think?"};
				};
		...
		case 10:
			dialogue = new Dialogue() {
				...
				@Override
				public String[] dialogue() {
					return new String[]{"To receive a member rank, you'd need to claim", "scrolls worth at least $10 (for the Bronze Member rank).", "Scrolls  can be purchased from the store", "which can be opened using the ::store command." };
				};
		...
		case 11:
			dialogue = new Dialogue() {
				...
				@Override
				public String[] dialogue() {
					return new String[]{"Ruse is a competitive game. Next to you is a scoreboard", "which you can use to track other players and their progress."};
				};
		...
		case 13:
			dialogue = new Dialogue() {
				...
				@Override
				public String[] dialogue() {
					return new String[]{"If you have any more questions, simply use the ::help", "command and a staff member should get back to you.", "You can also join the clanchat channel 'help' and ask", "other players for help there too. Have fun playing Ruse!"};
				};
				...
				public void specialAction() {
					...
					if(ConnectionHandler.getStarters(p.getHostAddress()) <= GameSettings.MAX_STARTERS_PER_IP) {
						if(p.getGameMode() != GameMode.NORMAL) {
							p.getInventory().add(995, 600000)
							.add(1153, 1).add(1115, 1)
							.add(1067, 1).add(1323, 1)
							.add(1191, 1).add(841, 1)
							.add(882, 50).add(1167, 1)
							.add(1129, 1).add(1095, 1)
							.add(1063, 1).add(579, 1)
							.add(577, 1).add(1011, 1)
							.add(1379, 1).add(556, 50)
							.add(558, 50).add(557, 50)
							.add(555, 50).add(1351, 1)
							.add(1265, 1).add(1712, 1).
							add(11118, 1).add(1007, 1).
							add(1061, 1).add(330, 100);
						} else {
							p.getInventory().add(995, 1000000)
							.add(1153, 1).add(1115, 1).add(1067, 1)
							.add(1323, 1).add(1191, 1).add(841, 1)
							.add(882, 1000).add(1167, 1).add(1129, 1).
							add(1095, 1).add(1063, 1).add(579, 1).
							add(577, 1).add(1011, 1).add(1379, 1).
							add(556, 1000).add(558, 1000).add(557, 1000)
							.add(555, 1000).add(1351, 1).add(1265, 1)
							.add(1712, 1).add(11118, 1).add(1007, 1)
							.add(1061, 1).add(386, 100);
						}
