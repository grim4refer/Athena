...
import com.ruse.model.input.impl.SetEmail;
	...
	public static void handle(Player player, int id) {
		...
		if(id == FIRST_OPTION_OF_FIVE) {
			...
			case 68:
				...
				break;
			case 87:
				if(player.getClickDelay().elapsed(1000) && !player.getInventory().contains(18351)) {
					player.getInventory().add(18351, 1);
			...
			case 68:
				...
				break;
			case 87:
				if(player.getClickDelay().elapsed(1000) && !player.getInventory().contains(18349)) {
					player.getInventory().add(18349, 1);
					DialogueManager.start(player, Tutorial.get(player, 0));
					player.getClickDelay().reset();
				}
				break;
			case 88:
				player.getPacketSender().sendString(1, "http://Ruseps.com/forums/index.php?/topic/2-member-rank-features/");
				break;
			}
			...
			case 68:
				...
				break;
			case 87:
				if(player.getClickDelay().elapsed(1000) && !player.getInventory().contains(18353)) {
					player.getInventory().add(18353, 1);
					DialogueManager.start(player, Tutorial.get(player, 0));
					player.getClickDelay().reset();
				}
				break;
			...
			case 68:
				...
				break;
			case 87:
				if(player.getClickDelay().elapsed(1000) && !player.getInventory().contains(18357)) {
					player.getInventory().add(18357, 1);
					DialogueManager.start(player, Tutorial.get(player, 0));
					player.getClickDelay().reset();
				}
				break;
			...
			case 83:
				...
				break;
			case 87:
				if(player.getClickDelay().elapsed(1000) && !player.getInventory().contains(18355)) {
					player.getInventory().add(18355, 1);
					DialogueManager.start(player, Tutorial.get(player, 0));
					player.getClickDelay().reset();
				}
				break;
			...
			case 83:
				...
				break;
			case 84:
				TeleportHandler.teleportPlayer(player, new Position(3683, 9888, player.getIndex() * 4), player.getSpellbook().getTeleportType());
				break;
			case 87:
			...
			case 31:
				...
				break;
			case 45:
				player.getPacketSender().sendString(1, "http://Ruseps.com/forums/index.php?/topic/3-ironman-modes/");
				break;
			case 83:
