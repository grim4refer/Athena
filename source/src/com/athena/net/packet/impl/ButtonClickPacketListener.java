...
import com.athena.world.content.ExperienceLamps;
...
import com.athena.world.content.StartScreen;
...
import com.athena.world.content.skill.impl.dungeoneering.ItemBinding;
...
public class ButtonClickPacketListener implements PacketListener {
	...
	public void handleMessage(Player player, Packet packet) {
		...
		case -29028:
			...
			break;
            case -17615:
                if(player.getInventory().hasItem(new Item(player.getItemToUpgrade(),1))) {
                    Upgrade.init(player, player.getItemToUpgrade());
                } else {
