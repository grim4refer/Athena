...
import com.athena.model.DwarfCannon;
...
import com.athena.world.content.combat.range.DwarfMultiCannon;
...
import com.athena.world.content.minigames.impl.FightCave;
		...
		player.setInteractingObject(gameObject).setWalkToTask(new WalkToTask(player, position, gameObject.getSize(), new FinalizedMovementTask() {
			...
			public void execute() {
				...
				case 38660:
					...
					break;
                    case 3422:
                    	player.setItemToUpgrade(0);
						player.getPacketSender().sendInterfaceReset();
                        player.getPA().sendInterface(47989);
						player.getPacketSender().sendItemOnInterface(47900, -1, 1);
						player.getPacketSender().sendItemOnInterface(47910, -1, 1);
						player.getPacketSender().sendItemOnInterface(47909, -1, 1);
						player.getPacketSender().sendItemOnInterface(47918, -1, 1);
						break;
				case 11434:
