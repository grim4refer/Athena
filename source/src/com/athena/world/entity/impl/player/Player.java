...
import com.athena.world.content.combat.magic.CustomMagicStaff;
import com.athena.world.content.mysteryboxes.MysteryBox;
...
import com.athena.model.container.impl.Inventory;
...
import com.athena.world.content.StartScreen.GameModes;
...
import com.athena.world.content.combat.pvp.PlayerKillingAttributes;
...
import com.athena.world.content.itemloading.CorruptBandagesLoading;
import com.athena.world.content.itemloading.MinigunLoading;
import com.athena.world.content.minigames.Minigame;
import com.athena.world.content.minigames.MinigameAttributes;
...
import com.athena.world.content.skill.impl.construction.HouseFurniture;
import com.athena.world.content.skill.impl.construction.Portal;
import com.athena.world.content.skill.impl.construction.Room;
import com.athena.world.content.skill.impl.construction.ConstructionData.HouseLocation;
import com.athena.world.content.skill.impl.construction.ConstructionData.HouseTheme;
import com.athena.world.content.skill.impl.farming.Farming;
...
public class Player extends Character {
    ...
    public static int[] guns = {21082,20695,21077,21079,894,21044,700,701,895,896,2867,21080};
...
private int npcKills;
    ...
    public int getAttackSpeed() {
        ...
        if (weaponId == 21080 || weaponId == 20605) {
            speed = 1;
        }        if (weaponId == 17847) {
            speed = 2;
        }
        ...
        if (weaponId == 21082 ||weaponId == 20603||weaponId == 20510|| weaponId == 21077) {
            speed = 1;
        }

        if (weaponId == 21002 || weaponId == 20695 || weaponId == 11539|| weaponId == 21060 || weaponId == 21063 || weaponId == 21013 || weaponId == 20079|| weaponId == 20102 || weaponId == 20607|| weaponId == 21003 || weaponId == 21030 || weaponId == 21031 || weaponId == 21032 || weaponId == 21033 || weaponId == 21004)  {
            speed = 2;
        }
