		...
		TaskManager.submit(new Task(1, player, true) {
			...
			public void execute() {
				...
				if(player.getRights() == PlayerRights.DONATOR) {
					...
					drain /= 2;
				}if(player.getRights() == PlayerRights.EXTREME_DONATOR ||player.getRights() == PlayerRights.SUPPORT||player.getRights() == PlayerRights.MODERATOR||player.getRights() == PlayerRights.ADMINISTRATOR||player.getRights() == PlayerRights.OWNER|| player.getRights() == PlayerRights.LEGENDARY_DONATOR || player.getRights() == PlayerRights.UBER_DONATOR) {
					drain = 0;
				}
