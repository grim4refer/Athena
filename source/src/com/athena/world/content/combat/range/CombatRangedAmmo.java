...
public class CombatRangedAmmo {
    ...
    public enum RangedWeaponData {
        ...
        DUEL(new int[] { 21080 }, new AmmunitionData[] {AmmunitionData.BLOOD_SHOT,AmmunitionData.BULLETS2 ,AmmunitionData.BULLETS},
                RangedWeaponType.CROSSBOW),
        AK(new int[] { 894,21044,20695,700,701,895,896,2867,21082,20705,21077,21079,21080  }, new AmmunitionData[] {AmmunitionData.ICE_1BALL,AmmunitionData.LAVA_BALL,AmmunitionData.BULLETS2,AmmunitionData.BULLETS,AmmunitionData.BLOOD_SHOT},
                RangedWeaponType.CROSSBOW),
