package com.athena.world.content.clan;
	...
	public static void handleLogin(Player player) {
		...
		if(player.getClanChatName() == null || player.getClanChatName().equals("null")) {
			if(Misc.getMinutesPlayed(player) <= 15) {
				player.getPacketSender().sendMessage("<img=10> <col=660099>Feel free to join the 'viper' clanchat channel to talk to other players.");
			}
		}
