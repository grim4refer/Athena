...
public class Store {
	...
	private static final String SECRET = "253321sfa45f"; //YOUR SECRET KEY!
	...
	public void claim(Player player){
		...
		try{
			...
			URL url = new URL("http://Ruseps.com/store/callback.php?secret="+SECRET+"&username="+URLEncoder.encode(player.getUsername().toLowerCase().replaceAll(" ", "_")));
