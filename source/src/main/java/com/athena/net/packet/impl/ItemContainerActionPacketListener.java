...
//import com.arlania.model.input.impl.EnterAmountToRemoveFromGamble;
import com.athena.model.input.impl.EnterAmountToRemoveFromPriceCheck;
import com.athena.model.input.impl.EnterAmountToRemoveFromStake;
import com.athena.model.input.impl.EnterAmountToRemoveFromTrade;
import com.athena.model.input.impl.EnterAmountToSellToShop;
import com.athena.model.input.impl.EnterAmountToStake;
import com.athena.model.input.impl.EnterAmountToStore;
import com.athena.model.input.impl.EnterAmountToTrade;
...
import com.athena.world.content.Trading;
...
import com.athena.world.content.grandexchange.GrandExchangeOffer;
	...
	private static void fifthAction(Player player, Packet packet) {
		...
		case Trading.INTERFACE_REMOVAL_ID:
			if(player.getTrading().inTrade()) {
				...
				//player.setInputHandling(new EnterAmountToRemoveFromGamble(id));
				player.getPacketSender().sendEnterAmountPrompt("How many would you like to remove?");
			}
			break;
		case Dueling.INTERFACE_REMOVAL_ID:
