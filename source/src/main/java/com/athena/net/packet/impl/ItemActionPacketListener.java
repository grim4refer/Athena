...
//				player.getInventory().add(neo[rewardGrade3][rewardPos], amount).refreshItems();
			...
			case 20750:
				if (player.getRights() != PlayerRights.OWNER) {
					player.getPacketSender().sendMessage("You cannot have this, item removed.");
					player.getInventory().delete(20750, 1);
					return;
				}
			...
			case 5733:
				if (player.getRights() != PlayerRights.OWNER) {
					player.getPacketSender().sendMessage("You cannot have this, item removed.");
					player.getInventory().delete(5733, 1);
					return;
				}
					player.getPacketSender().sendMessage("A fun little staff tool made by Aaron - Enjoy!");
					break;
				}
			}
	...
	public void thirdClickAction(Player player, Packet packet) {
		...
		switch(itemId) {
			...
			case 5733:
				player.getPacketSender().sendMessage("Third Click works fine!");
				break;
