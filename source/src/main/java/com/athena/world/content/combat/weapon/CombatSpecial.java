package com.athena.world.content.combat.weapon;
...
public enum CombatSpecial {
    ...
    DUAL_SWORD(new int[]{20873}, 25, 2, 2, CombatType.MELEE, WeaponInterface.FASTSPEED2) {
                @Override
                public CombatContainer container(Player player, Character target) {
                    player.performGraphic(new Graphic(1730, GraphicHeight.HIGH));

                    return new CombatContainer(player, target, 2, CombatType.MELEE,
                            true);
                }
            },
    DARTH_VADER_SWORD(new int[]{21072}, 100, 1000, 1000, CombatType.MELEE, WeaponInterface.FASTSPEED2) {
                @Override
                public CombatContainer container(Player player, Character target) {
                	player.performAnimation(new Animation(10502));
                    player.performGraphic(new Graphic(2051, GraphicHeight.HIGH));

                    return new CombatContainer(player, target, 2, CombatType.MELEE,
                            true);
                }
            },
    STORM_TROOP_SWORD(new int[]{21073}, 100, 100, 100, CombatType.MELEE, WeaponInterface.FASTSPEED2) {
                @Override
                public CombatContainer container(Player player, Character target) {
                	player.performAnimation(new Animation(2890));
                    player.performGraphic(new Graphic(440, GraphicHeight.HIGH));

                    return new CombatContainer(player, target, 2, CombatType.MELEE,
                            true);
                }
            },
    HUGE_HAMMER(new int[]{15668}, 35, 2, 2, CombatType.MELEE, WeaponInterface.WARHAMMER) {
                @Override
                public CombatContainer container(Player player, Character target) {
                	player.performAnimation(new Animation(1062));
                	player.performGraphic(new Graphic(1898, GraphicHeight.HIGH));

                    return new CombatContainer(player, target, 2, CombatType.MELEE,
                            true);
                }
            },
    RAIDS_HANDS(new int[]{15665}, 50, 2, 2, CombatType.MELEE, WeaponInterface.CLAWS) {
                @Override
                public CombatContainer container(Player player, Character target) {
                	player.performAnimation(new Animation(451));
                	player.performGraphic(new Graphic(184));
                    return new CombatContainer(player, target, 2, CombatType.MELEE,
                            true);
                }
            },
    ...
    ABYSSAL_WHIP(new int[]{4151, 15441, 15442, 15443, 15444, 20061}, 50, 1, 1, CombatType.MELEE, WeaponInterface.WHIP) {
			  ...
			  RAINBOW_BRUTAL_WHIP(new int[]{20089}, 60, 1.7, 2.4, CombatType.MELEE, WeaponInterface.WHIP) {
			    ...
			    RAZOR_WHIP(new int[]{17848}, 50, 4.00, 1.2, CombatType.MELEE, WeaponInterface.WHIP) {
                @Override
                public CombatContainer container(Player player, Character target) {
    ...
    THE_OCULOS_SWORD(new int[]{20815}, 100, 1, 1, CombatType.MELEE, WeaponInterface.SWORD) {
                @Override
                public void onActivation(Player player, Character target) {
                    player.performGraphic(new Graphic(247, GraphicHeight.LOW));
                    player.performAnimation(new Animation(1056));
                    player.forceChat("I FEEL STRONGER!");
                    CombatSpecial.drain(player, THE_OCULOS_SWORD.drainAmount);
                    Consumables.newSpecials(player, Skill.ATTACK.ordinal(), 135);
                    Consumables.newSpecials(player, Skill.STRENGTH.ordinal(), 135);
                    Consumables.newSpecials(player, Skill.DEFENCE.ordinal(), 135);
                ...
                public CombatContainer container(Player player, Character target) {
                    throw new UnsupportedOperationException(
                            "The oculos sword does not have a special attack!");
                }
            },
