...
public enum CombatSpells {
	...
	KYRPTIC_SPELL(new CombatNormalSpell() {
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 970, 0, 0, 43, 31,
					0));
		}
	...
	DRACONIAN_SPELL(new CombatNormalSpell() {
		@Override
		public Optional<Animation> castAnimation() {
			return Optional.of(new Animation(14220));
		}
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 2119, 40, 3, 43, 31,
					0));
		}
		...
		@Override
		public Optional<Graphic> startGraphic() {
			return Optional.of(new Graphic(1194));
		}
	...
	ANGELIC_SPELL(new CombatNormalSpell() {
		@Override
		public Optional<Animation> castAnimation() {
			return Optional.of(new Animation(14220));
		}
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 266, 40, 3, 43, 31,
					0));
		}
		...
		@Override
		public Optional<Graphic> startGraphic() {
			return Optional.of(new Graphic(310));
		}
	...
	INFERNAL_BATTLESTAFF_SPELL(new CombatNormalSpell() {
		@Override
		public Optional<Animation> castAnimation() {
			return Optional.of(new Animation(15078));
		}
		...
		@Override
		public Optional<Graphic> startGraphic() {
			return Optional.of(new Graphic(1028));
		}
	...
	ELITE_SPELL(new CombatNormalSpell() {
		@Override
		public Optional<Animation> castAnimation() {
		...
		@Override
		public Optional<Graphic> endGraphic() {
			return Optional.of(new Graphic(369, GraphicHeight.MIDDLE));
		}
	...
	EARTH_STRIKE(new CombatNormalSpell() {
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 370, 44, 3, 43, 31,
					0));
		}

		@Override
		public Optional<Graphic> endGraphic() {
			return Optional.of(new Graphic(2222, GraphicHeight.MIDDLE));
		}
	...
	VORAGO(new CombatNormalSpell() {
	@Override
	public Optional<Animation> castAnimation() {
		return Optional.of(new Animation(14200));
	}

	@Override
	public Optional<Projectile> castProjectile(Character cast, Character castOn) {
		return Optional.of(new Projectile(cast, castOn, 69, 68, 3, 43, 31,
				0));
	}

	@Override
	public Optional<Graphic> endGraphic() {
		return Optional.of(new Graphic(68, GraphicHeight.MIDDLE));
	}
	...
	@Override
	public Optional<Graphic> startGraphic() {
		return Optional.of(new Graphic(1585));
	}
	...
	BALOON_STAFF(new CombatAncientSpell() {
		@Override
		public void spellEffect(Character cast, Character castOn, int damage) {
			castOn.getMovementQueue().freeze(7);
		}
		...
		@Override
		public Optional<Animation> castAnimation() {
			return Optional.of(new Animation(11227));
		}
		...
		@Override
		public Optional<Graphic> endGraphic() {
			return Optional.of(new Graphic(1273));
		}
	...
	INFERNAL_STAFF(new CombatAncientSpell() {
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 360, 1, 10, 43, 31,
					0));
		}

		@Override
		public Optional<Graphic> endGraphic() {
			return Optional.of(new Graphic(1173));
		}
