package com.athena.world.content.combat.range;
...
public class CombatRangedAmmo {
    ...
    public enum AmmunitionData {
        ...
        BRONZE_DART(new int[] { 806 }, 1234, 226, 30, 25, 2, 45, 37), IRON_DART(new int[] { 807 }, 1235, 227, 30, 25, 5,
                ...
                37), RUNE_DART(new int[] { 811 }, 1240, 231, 30, 25, 20, 45, 37), 
        DRAGON_DART(new int[] { 11230 }, 1123, 226, 30, 25, 25, 45, 37),
        DEATH_TOUCH_DART(new int[] { 7684 }, 1123, 226, 30, 25, 25, 45, 37),
        DOFLAMINGO(new int[] { -1 }, 1990, 1991, 3, 33, 70, 43, 31,83),
        ...
        DEATH_TOUCH_DARTS(new int[] { 7684 }, -1, -1, 17, 8, 80, 45, 37),
    ...
    public enum RangedWeaponData {
        ...
        GUNS(new int[] { 20932 },
                new AmmunitionData[] { AmmunitionData.DOFLAMINGO  }, RangedWeaponType.CROSSBOW),
        ...
        DEATH_TOUCH_DART(new int[] { 7684 }, new AmmunitionData[] { AmmunitionData.DEATH_TOUCH_DART }, RangedWeaponType.THROW),
        ...
        LAVA_GUN(new int[] { }, new AmmunitionData[] {AmmunitionData.BULLETS2, AmmunitionData.ICE_1BALL },
                RangedWeaponType.CROSSBOW),
        
    	DOFLAMINGO_MINIGUN(new int[] { 20932 }, new AmmunitionData[] {AmmunitionData.DOFLAMINGO},
                RangedWeaponType.CROSSBOW);
        ...
        public static AmmunitionData getAmmunitionData(Player p) {
            ...
            if (data != null) {
                ...
                if (p.getRangedWeaponData() == RangedWeaponData.GUNS) {
                    return AmmunitionData.DOFLAMINGO;
                }
                ...
                if (p.getRangedWeaponData() == RangedWeaponData.THUNDER_GUN) {
                    ...
                    return AmmunitionData.BULLETS2;
