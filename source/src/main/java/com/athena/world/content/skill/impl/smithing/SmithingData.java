package com.athena.world.content.skill.impl.smithing;

import com.athena.model.Item;
import com.athena.model.Skill;
import com.athena.model.definitions.ItemDefinition;
import com.athena.model.input.impl.EnterAmountOfBarsToSmelt;
...
public class SmithingData {
	...
	public static final int[] SMELT_BARS = { 2349, 2351, 2355, 2353, 2357, 2359, 2361, 2363,20950};
	...
	public static final int[][] SmeltData = {
		...
		{2353, 453, -1, 30, 350}, // Steel bar
		{2357, 444, -1, 40, 400}, // Gold bar
		{2359, 447, -1, 50, 450}, // Mithril bar
		{2361, 449, -1, 70, 500}, // Adamantite bar
		{2363, 451, -1, 85, 560} // Runite bar
	};
	...
	public static void makeAmmoInterface(Player player) {
		String fiveb = GetForBars(20950, 5, player);
		String threeb = GetForBars(20950, 3, player);
		String twob = GetForBars(20950, 2, player);
		String oneb = GetForBars(20950, 1, player);
			sendString(player, fiveb+""+fiveb, 1112);
			sendString(player, threeb+""+threeb, 1109);
			sendString(player, threeb+""+threeb, 1110);
			sendString(player, threeb+""+threeb, 1118);
			sendString(player, threeb+""+threeb, 1111);
			sendString(player, threeb+""+threeb, 1095);
			sendString(player, threeb+""+threeb, 1115);
			sendString(player, threeb+""+threeb, 1090);
			sendString(player, twob+""+twob, 1113);
			sendString(player, twob+""+twob, 1116);
			sendString(player, twob+""+twob, 1114);
			sendString(player, twob+""+twob, 1089);
			sendString(player, twob+""+twob, 8428);
			sendString(player, oneb+""+oneb, 1124);
			sendString(player, oneb+""+oneb, 1125);
			sendString(player, oneb+""+oneb, 1126);
			sendString(player, oneb+""+oneb, 1127);
			sendString(player, oneb+""+oneb, 1128);
			sendString(player, oneb+""+oneb, 1129);
			sendString(player, oneb+""+oneb, 1130);
			sendString(player, oneb+""+oneb, 1131);
			sendString(player, oneb+""+oneb, 13357);
			sendString(player, oneb+""+oneb, 11459);
		sendString(player, GetForlvl(88, player)+""+GetForlvl(18, player), 1101);
		sendString(player, GetForlvl(99, player)+""+GetForlvl(16, player), 1099);
		sendString(player, GetForlvl(99, player)+""+GetForlvl(16, player), 1100);
		sendString(player, GetForlvl(99, player)+""+GetForlvl(14, player), 1088);
		sendString(player, GetForlvl(97, player)+""+GetForlvl(12, player), 1105);
		sendString(player, GetForlvl(96, player)+"Infernal Bullet"+GetForlvl(11, player), 1098);
		sendString(player, GetForlvl(95, player)+""+GetForlvl(10, player), 1092);
		sendString(player, GetForlvl(94, player)+""+GetForlvl(9, player), 1083);
		sendString(player, GetForlvl(93, player)+""+GetForlvl(8, player), 1104);
		sendString(player, GetForlvl(92, player)+""+GetForlvl(7, player), 1103);
		sendString(player, GetForlvl(92, player)+""+GetForlvl(7, player), 1106);
		sendString(player, GetForlvl(91, player)+""+GetForlvl(6, player), 1086);
		sendString(player, GetForlvl(34, player)+""+GetForlvl(4, player), 9141);
		sendString(player, GetForlvl(74, player)+""+GetForlvl(4, player), 9143);
		sendString(player, GetForlvl(90, player)+""+GetForlvl(5, player), 1087);
		sendString(player, GetForlvl(90, player)+""+GetForlvl(5, player), 1108);
		sendString(player, GetForlvl(89, player)+""+GetForlvl(4, player), 1085);
		player.getPacketSender().sendString(8429, GetForlvl(8, player) + "" + GetForlvl(8, player));
		sendString(player, GetForlvl(89, player)+""+GetForlvl(4, player), 9144);
		sendString(player, GetForlvl(89, player)+""+GetForlvl(4, player), 13358);
		sendString(player, GetForlvl(88, player)+"Ice Bullet"+GetForlvl(3, player), 1102);
		sendString(player, GetForlvl(87, player)+""+GetForlvl(2, player), 1093);
		sendString(player, GetForlvl(89, player)+""+GetForlvl(4, player), 9144);
		player.getPacketSender().sendString(1107, GetForlvl(4, player) + "" + GetForlvl(4, player));

		sendString(player, GetForlvl(85, player)+"Bullet"+GetForlvl(1, player), 1094);
		sendString(player, GetForlvl(86, player)+"Blood Bullet"+GetForlvl(1, player), 1091);
		player.getPacketSender().sendSmithingData(19906,0,1119,1); //dagger
		player.getPacketSender().sendSmithingData(19905,0,1120,1); //axe
		player.getPacketSender().sendSmithingData(19904,0,1121,1); //chain body
		player.getPacketSender().sendSmithingData(19903,0,1122,1); //med helm
		player.getPacketSender().sendSmithingData(-1,0,1123,10); //Bolts
		player.getPacketSender().sendSmithingData(-1,1,1119,1); //s-sword
		player.getPacketSender().sendSmithingData(-1,1,1120,1); //mace
		player.getPacketSender().sendSmithingData(-1,1,1121,1); //platelegs
		player.getPacketSender().sendSmithingData(-1,1,1122,1); //full helm
		player.getPacketSender().sendSmithingData(-1,1,1123,15); //arrowtips
		player.getPacketSender().sendSmithingData(-1,2,1119,1); //scimmy
		player.getPacketSender().sendSmithingData(-1,2,1120,1); //warhammer
		player.getPacketSender().sendSmithingData(-1,2,1121,1); //plateskirt
		player.getPacketSender().sendSmithingData(-1,2,1122,1); //Sq. Shield
		player.getPacketSender().sendSmithingData(-1,2,1123,5); //throwing-knives
		player.getPacketSender().sendSmithingData(-1,3,1119,1); //longsword
		player.getPacketSender().sendSmithingData(-1,3,1120,1); //battleaxe
		player.getPacketSender().sendSmithingData(-1,3,1121,1); //platebody
		player.getPacketSender().sendSmithingData(-1,3,1122,1); //kiteshield
		player.getPacketSender().sendSmithingData(-1,4,1119,1); //2h sword
		player.getPacketSender().sendSmithingData(-1,4,1122,15); //nails
		player.getPacketSender().sendSmithingData(-1,3,1123, 1);
		player.getPacketSender().sendSmithingData(-1,4,1120, 1); // claws
		sendString(player, "",1135);
		sendString(player, "",1134);
		sendString(player, "",11461);
		sendString(player, "",11459);
