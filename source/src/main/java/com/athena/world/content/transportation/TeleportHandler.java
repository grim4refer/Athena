package com.athena.world.content.transportation;
...
public class TeleportHandler {
	...
	public static void teleportPlayer(final Player player, final Position targetLocation, final TeleportType teleportType) {
		...
		if(!player.getClickDelay().elapsed(4500) || player.getMovementQueue().isLockMovement() || player.currentRaidSession != null && player.currentRaidSession.joinedRaid(player))
			return;
