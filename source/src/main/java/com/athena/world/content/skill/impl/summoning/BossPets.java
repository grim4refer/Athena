package com.athena.world.content.skill.impl.summoning;
...
public class BossPets {
	...
	public enum BossPet {
		...
		PET_DEDICATED_DONATOR(2241, 2241, 14997),//TODO
		...
		PET_KING_MOUNT(2072, 2072, 20826),
		PET_YOSHI(2073, 2073, 20827),
		PET_VORAGO(2074, 2074, 20828),
		PET_HULK(0, 0, 20898),
		PET_BALOON(1, 1, 20899),
		PET_SPYRO(2075, 2075, 20837),
		PET_ANT(10142, 10142, 20860),
		PET_CA(4, 4, 20902),
		PET_IRONMAN(5, 5, 20911),
		PET_SPIDERMAN(6, 6, 20912),
		PET_ANTMAN(9, 9, 20915),
		PET_TERRORDOG(5418, 5418, 20921),
		PET_CAR(16, 16, 20929),
		PET_CRASH(14, 14, 20930),
		PET_LUCARIO(6360, 6360, 20967),
		PET_MEWTWO(6357,6357, 20968),
		PET_CHARMELEON(6358, 6358, 20969),
		PET_SQUIRTLE(6361, 6361, 20970),
		PET_PIKACHU(6366, 6366, 2762),
		PET_SONIC(6363, 6363, 2760),
		PET_DONKEYKONG(1302, 1302, 20973),
		PET_MRKRABS(6362, 6362, 2759),
		PET_NUTELLAS(6301, 6301, 20975),
		PET_MAYONNAISE(6355, 6355, 20977);
