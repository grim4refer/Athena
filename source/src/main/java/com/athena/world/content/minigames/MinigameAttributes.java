...
public class MinigameAttributes {
	...
	private final RestoreAltar restAlt = new RestoreAltar();
	...
	public class RestoreAltar {
		...
		public RestoreAltar setAltarDelay(long altarDelay) {
			this.altarDelay = altarDelay;
			return this;
		}
	}
	...
	public RestoreAltar getRestoreAltarAttributes() {
		return restAlt;
	}
