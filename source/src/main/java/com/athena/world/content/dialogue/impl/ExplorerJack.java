...
import com.athena.model.input.impl.ItemSearch;
	...
	public static Dialogue getDialogue(Player player) {
		return new Dialogue() {
			...
			public String[] dialogue() {
				return new String[]{"Hello adventurer.", "Wan't to know what npc drops a desired item?", "Search it with my hefty sql", "Which npc drop would you like to know about?"};
			}
