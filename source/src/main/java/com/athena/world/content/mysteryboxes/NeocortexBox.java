	...
	public void process() {
		...
		if (player.getInventory().hasItem(new Item(BOX, 1))) {
			...
			if(randomYoda == 0) {
				...
				plr.sendMessage("<shad=0>@bla@[@whi@Dark box@bla@] @whi@"+plr.getUsername()+"@bla@ Has just received a @whi@ "+ItemDefinition.forId(oblivion[rewardGrade3][rewardPos]).getName()+" @bla@!");
