 ...
 * @author Tibo
 */
public class YanilleMysteryBox {
	 ...
	 *            the player
	 */
	public YanilleMysteryBox(Player plr) {
		this.plr = plr;
	}
	...
	public void process() {
		...
		if(rewards2[rewardGrade][rewardPos] == 11556) {
			World.sendMessage("<shad=15664412>[Yanille box] @or1@"+plr.getUsername()+"@whi@ Has just received @yel@Ring of <shad=15695415>DEATH!");
		}
		if(rewards2[rewardGrade][rewardPos] == 20257) {
			World.sendMessage("<shad=15664412>[Yanille box] @or1@"+plr.getUsername()+"@whi@ Has just received @yel@Blood <shad=15695415>NECKLACE!");
		}
		if(rewards2[rewardGrade][rewardPos] == 18911) {
			World.sendMessage("<shad=15664412>[Yanille box] @or1@"+plr.getUsername()+"@whi@ Has just received @yel@Creature <shad=15695415>WHIP!");
		}
		if(rewards2[rewardGrade][rewardPos] == 20054) {
			World.sendMessage("<shad=15664412>[Yanille box] @or1@"+plr.getUsername()+"@whi@ Has just received @yel@Ring of <shad=15695415>DEVOTION!");
		}
		if(rewards2[rewardGrade][rewardPos] == 20064) {
			World.sendMessage("<shad=15664412>[Yanille box] @or1@"+plr.getUsername()+"@whi@ Has just received @yel@ <shad=15695415>CRAMULET!");
		}
		if(rewards2[rewardGrade][rewardPos] == 11555) {
			World.sendMessage("<shad=15664412>[Yanille box] @or1@"+plr.getUsername()+"@whi@ Has just received @yel@Ring of <shad=15695415>CHAOS!");
		}
		if(rewards2[rewardGrade][rewardPos] == 20752) {
			World.sendMessage("<shad=15664412>[Yanille box] @or1@"+plr.getUsername()+"@whi@ Has just received @yel@The Sponsor <shad=15695415>GLAIVE!");
		}
		if(rewards2[rewardGrade][rewardPos] == 20750) {
			World.sendMessage("<shad=15664412>[Yanille box] @or1@"+plr.getUsername()+"@whi@ Has just received @red@The Owner <shad=800000000>CAPE!");
		}
		}
	}
