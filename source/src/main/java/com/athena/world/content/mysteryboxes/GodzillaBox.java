	...
	public void process() {
		if (plr.getInventory().hasItem(new Item(BOX, 1))) {
			...
			if(randomYoda == 0) {
				...
				plr.sendMessage("<shad=0>@bla@[<col=10923181>Dark Predator@bla@] <col=10923181>"+plr.getUsername()+"@bla@ Has just received a <col=10923181>"+ItemDefinition.forId(godzilla[rewardGrade3][rewardPos]).getName()+" @bla@from <col=10923181>Godzilla box!");
