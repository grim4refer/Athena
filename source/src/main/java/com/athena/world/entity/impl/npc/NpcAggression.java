...
public final class NpcAggression {
	...
	public static void target(Player player) {
		...
		for (NPC npc : player.getLocalNpcs()) {
			...
			/** GWD **/
			boolean gwdMob = Nex.nexMob(npc.getId()) || npc.getId() == 6261 || npc.getId() == 6263 || npc.getId() == 6265 || npc.getId() == 6222 || npc.getId() == 6223 || npc.getId() == 6225 || npc.getId() == 6227 || npc.getId() == 6203 || npc.getId() == 6208 || npc.getId() == 6204 || npc.getId() == 6206 || npc.getId() == 6247 || npc.getId() == 6248 || npc.getId() == 6250 || npc.getId() == 6252;
			if(gwdMob) {
