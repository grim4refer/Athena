...
import com.athena.world.content.minigames.impl.weapon.WeaponGameWeapons;
...
public class Locations {
	...
	public enum Location {
        GODS_RAID(new int[] { 1800,  1900 }, new int[] {5100, 5200 }, true, false,
                false, false, false, false) {
            @Override
            public void enter(Player player) {
                World.minigameHandler.getMinigame(0).handleLocationEntry(player);
                player.sendMessage("You just joined custom raid!");
            }

            @Override
            public void leave(Player player) {
                World.minigameHandler.getMinigame(0).handleLocationOutry(player);
				player.sendMessage("You just left custom raid!");
		...
		MULTIBOSS(new int[]{2888, 2918}, new int[]{2765, 2795}, true, true, true, true, true, true) {
		},
		...
		WILDERNESS(new int[]{2941, 3392, 2986, 3012, 3653, 3710, 3650, 3653}, new int[]{3523, 3968, 10338, 10366, 3441, 3538, 3457, 3472}, false, true, true, true, true, true) {
			...
			public boolean canAttack(Player player, Player target) {
				if(!GameSettings.WILDERNESS_ATTACK_ENABLED)
					return false;
		...
		MULTIRAIDS(new int[]{3051, 9579}, new int[]{3054, 9582}, true, true, false, false, false, false) {
			@Override
			public void process(Player player) {}
		...
		RECIPE_FOR_DISASTER(new int[]{1885, 1913}, new int[]{5340, 5369}, true, true, false, false, false, false) {
			...
			public void leave(Player player) {
				if(player.getRegionInstance() != null)
					player.getRegionInstance().destruct();
				player.moveTo(new Position(2561, 2532, 1));
			}
		...
		},UndeadInfernalDragon(new int[]{2698, 2738}, new int[]{4755, 4790}, true, true, true, false, true, true) {
		},vorago(new int[]{2234, 2287}, new int[]{3291, 3324}, true, true, true, false, true, true) {
		},
