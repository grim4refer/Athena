...
public class OverloadPotionTask extends Task {
	...
	public void execute() {
		...
		if(player.getOverloadPotionTimer() <= 0 || player.getLocation() == Location.DUEL_ARENA || player.getLocation() == Location.WILDERNESS && player.getRights() != PlayerRights.DELUXE_DONATOR) {
