...
public class CombatContainer {
	...
	public CombatContainer(Character attacker, Character victim, int hitAmount, CombatType hitType, boolean checkAccuracy) {
		...
		this.hitDelay = hitType == CombatType.MELEE ? 0 : hitType == CombatType.RANGED ? 1 : hitType == CombatType.GANO_MAGE ? 1 : hitType == CombatType.MAGIC || hitType == CombatType.DRAGON_FIRE ? 2 : 1;
	}
