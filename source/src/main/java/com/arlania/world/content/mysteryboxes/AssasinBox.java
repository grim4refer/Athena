	...
	public void process() {
		...
		if (plr.getInventory().hasItem(new Item(BOX, 1))) {
			...
			if(randomYoda == 0) {
				...
				plr.sendMessage("<shad=0>@bla@[<col=20451204>Assassin box@bla@] <col=20451204>"+plr.getUsername()+"@bla@ Has just received a <col=20451204> "+ItemDefinition.forId(assassin[rewardGrade3][rewardPos]).getName()+" @bla@from <col=20451204>Assassin box!");
