...
public class TeleportInterface {
	...
	public enum Monsters {
		...
		ANGRY_REX(50616, "Yanille Guardian", "@red@Guardian Npc!", "@yel@Drops Guardian items!", "", "", "", 6305, new int[] { 2482, 10146, 0 }),
	...
	public enum Minigames {
		...
		PEST_CONTROL(50604, "Point Zone", "@red@Yanille Warriors", "@mag@Drops Warriors items!", "", "", "", 2436, new int[] { 2766, 2799, 0 }),
