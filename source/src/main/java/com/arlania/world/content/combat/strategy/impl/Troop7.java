...
public class Troop7 implements CombatStrategy {

		private static final Animation anim = new Animation(412);
		private static final Animation anim2 = new Animation(2890);
		private static final Animation anim3 = new Animation(440);
		private static final Graphic gfx1 = new Graphic(481, 3, GraphicHeight.MIDDLE); // 1890 // 1892
		private static final Graphic gfx2 = new Graphic(2100);
