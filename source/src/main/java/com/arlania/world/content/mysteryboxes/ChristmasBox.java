...
public class ChristmasBox {
	 ...
	 *            the player
	 */
	public ChristmasBox(Player plr) {
		this.plr = plr;
	}
	...
	public void process() {
		...
		plr.getInventory().delete(20681, 1);
		plr.getInventory().add(rewards2[rewardGrade][rewardPos], 1).refreshItems();
		if(rewards2[rewardGrade][rewardPos] == 3959) {
			plr.sendMessage("@bla@[@or2@Cape box@bla@] @or1@"+plr.getUsername()+"@bla@ Has just received Dragonrage wings!");
		}
		}
	}
