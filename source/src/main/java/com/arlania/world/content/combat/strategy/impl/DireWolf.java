...
public class DireWolf implements CombatStrategy {
	...
	public boolean customContainerAttack(Character entity, Character victim) {
		...
		if(phase == 0)
		{
			...
			if(rand == 5) {
				new CombatHitTask(entity.getCombatBuilder(), new CombatContainer(entity, player, 3, CombatType.MAGIC, true)).handleAttack();
				...
				new CombatHitTask(entity.getCombatBuilder(), new CombatContainer(entity, player, 2, CombatType.MAGIC, true)).handleAttack();
				new CombatHitTask(entity.getCombatBuilder(), new CombatContainer(entity, player, 2, CombatType.MAGIC, true)).handleAttack();
				entity.performAnimation(new Animation(6579));
				player.performGraphic(new Graphic(377));
