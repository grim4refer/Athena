...
public class Misc {
	...
	private static final String[] BANNED_WORDS = new String[]{
            "devious", "firepk", "<", ">", "<img", "ventrilica", "ventrili",
    ...
    public static String filterMessage(Player player, String clanMessage) {
		return clanMessage;
	}
    public static String println_debug(String str) {
