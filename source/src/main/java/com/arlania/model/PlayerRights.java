...
public enum PlayerRights {
	...
	DEDICATED_DONATOR(-1,"<col=0EBFE9>", 3, 1.5),
	...
	private static final ImmutableSet<PlayerRights> STAFF = Sets.immutableEnumSet(SUPPORT, MODERATOR, ADMINISTRATOR, OWNER, DELUXE_DONATOR,FORUM_DEVELOPER);
