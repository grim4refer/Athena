...
/*     */ public final class Background extends DrawingArea { public byte[] imgPixels;
	...
	/*     */   {
		/*     */     try
			...
			/* 115 */       if (y < topY)
				...
				/* 121 */         l1 += j2 * k3;
				/*     */       }
			/* 123 */       if (y + stretchHeight > bottomX)
				/* 124 */         stretchHeight -= y + stretchHeight - bottomX;
			/* 125 */       if (x < topX)
				/*     */       {
				/* 127 */         int width2 = topX - x;
				...
				/* 132 */         j3 += width2;
				/*     */       }
			/* 134 */       if (x + stretchWidth > bottomY)
				/*     */       {
				/* 136 */         int i4 = x + stretchWidth - bottomY;
				/* 137 */         stretchWidth -= i4;
				/* 138 */         j3 += i4;
				/*     */       }
			/* 140 */       plotScale(pixels, this.imgPixels, this.palette, k1, l1, i3, j3, stretchWidth, stretchHeight, i2, j2, width);
			/*     */     }
	...
	/*     */   {
		...
		/* 245 */     if ((k1 > 0) && (j1 > 0))
			/*     */     {
			/* 247 */       drawPixels(j1, pixels, this.imgPixels, l1, l, k1, i1, this.palette, i2);
			/*     */     }
		/*     */   }
	/*     */
	/*     */
