...
public final class ObjectDef {
	...
	public static ObjectDef forID(int i) {
		...
		if (i == 409) {
			...
			objectDef.actions[1] = "Offer bones";
		}
		...
		if(i == 38700) {
			objectDef.name = "@red@Raids Entry";
		}
		if(i == 47748) {
			objectDef.name = "@red@Christmas @whi@Tree @blu@Teleport";
			objectDef.hasActions = true;
			objectDef.actions = new String[5];
			objectDef.actions[0] = "Access";
		}
		if(i == 13289) {
			objectDef.name = "@red@Raids @yel@Chest";
			objectDef.hasActions = true;
			objectDef.actions = new String[5];
			objectDef.actions[0] = "Open";
		...
		switch (i) {
			...
			case 6715:
				...
				objectDef.name = "@mag@Upgrade Machine";
					...
					break;
				case 7171:
					objectDef.name = "@mag@Portal";
					objectDef.actions = new String[5];
					objectDef.actions[0] = "@cya@Raids @red@Entry";
					//objectDef.actions[1] = "Create";
					break;
				case 10781:
					objectDef.name = "@dre@SHADOW @mag@LORD";
					//objectDef.actions[1] = "Create";
					break;
				case 10251:
					objectDef.actions = new String[5];
					objectDef.actions[0] = "@gre@Culinar";
					//objectDef.actions[1] = "Create";
					break;
