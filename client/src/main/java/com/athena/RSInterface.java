...
public class RSInterface {
	...
	public static void teleportInterface(TextDrawingArea[] tda) {
		String[] categories = new String[] { "@gre@Monsters", "@mag@Bosses", "@cya@Minigames", "  @yel@Shops", "   @red@Events", "@bla@Raids" };
		RSInterface main = addInterface(50500);
		addSprite(50501, 0, "Interfaces/Teleport/TELEPORT"); //1066
		main.totalChildren(22);
		main.child(0, 50501, 7, 10);

		addClickableText(50502, categories[0], "Select", tda, 0, 0xFF9900, 55, 25);
		addClickableText(50503, categories[1], "Select", tda, 0, 0xFF9900, 55, 25);
		addClickableText(50504, categories[2], "Select", tda, 0, 0xFF9900, 55, 25);
		addClickableText(50505, categories[3], "Select", tda, 0, 0xFF9900, 55, 25);
		addClickableText(50506, categories[4], "Select", tda, 0, 0xFF9900, 55, 25);
		addClickableText(50507, categories[5], "Select", tda, 0, 0xFF9900, 55, 25);
		main.child(1, 50502, 56 - 15, 23);
		main.child(2, 50503, 134 - 15, 23);
		main.child(3, 50504, 215 - 23, 23);
		main.child(4, 50505, 295 - 20, 23);
		main.child(5, 50506, 374 - 22, 23);
		main.child(6, 50507, 454 - 17, 23);
		main.child(7, 50600, 0, 71);
		main.child(8, 50508, 45, 50);
		main.child(9, 50509, 215, 66);
		main.child(10, 50510, 405, 66);
		main.child(11, 50511, 210, 243);
		main.child(12, 51250, 0, 266);
		main.child(18, 50512, 155, 210);
		main.child(19, 50513, 220, 214);
		main.child(20, 50514, 155, 100);
		main.child(21, 50515, 155, 210);

		addText(50508, "x names", 0xFF9900, false, true, 52, tda, 2);
		addText(50509, "Preview", 0xFF9900, true, true, 100, tda, 2);
		addText(50510, "Description", 0xFF9900, true, true, 100, tda, 2);
		addText(50511, "Drops", 0xFF9900, true, true, 100, tda, 2);

		addNpc(50514, 131);
		//addButtonWSpriteLoader(50512, 1069, "Teleport");
		addHover(50512, 1, 0, 50515, 3, "Interfaces/Teleport/TELEPORT", 132, 23, "Teleport");
		addHovered(50515, 1, "Interfaces/PlayerProfile/SPRITE", 72, 32, 50516);
		addText(50513, "Teleport", 0xffef0a, true, true, 100, tda, 2);
		int descriptionChild = 13;
		int descriptionX = 342;
		int descriptionY = 90;

		for (int descriptionText = 51200; descriptionText < 51205; descriptionText++) {
			addText(descriptionText, "Description here", 0xFF9900, false, true, 100, tda, 1);
		...
		dropsScroll.width = 485;
		dropsScroll.height = 60;
		dropsScroll.scrollMax = 1000;
		...
		nameScroll.width = 125;
		nameScroll.height = 255;
	 ...
	 */
		for (int bossText = 50601; bossText < 50700; bossText++) {
			addHoverableText(bossText, "", "Select", fonts, 1, false, false, 130, 0xFF9900, 0xffffff);
			nameScroll.child(bossChild, bossText, overAllX, bossY); //try again
			bossChild++; //kk try load it in, boss names should now have highligh
			bossY += 14;
		}
	}

	public static void slotInterface(TextDrawingArea[] tda) {
		final RSInterface widget = addTabInterface(29030);
		setChildren(12, widget);

		addSpriteLoader(29031,1251);
		setBounds(29031, 68, 8, 0, widget);

		addText(29032, "Slot Machine", 0xFF981F, true, true, -1, 2);
		setBounds(29032, 256, 13, 1, widget);

		addToItemGroup(29033, 3, 1, 45, 8, false, null, null, null);
		setBounds(29033, 160, 103, 2, widget);

		addItemOnInterface(29036, 28999,  new String[]{});
		setBounds(29036, 240, 205, 3, widget);

		addHoverButtonWSpriteLoader(29037, 1236, 100, 32, "Roll", 0, 29038, 1);
		setBounds(29037, 143, 274, 4, widget);
		addHoveredImageWSpriteLoader(29038, 1237, 100, 32, 29038 + 1);
		setBounds(29038, 143, 274, 5, widget);

		addText(29040,"Roll", 0xFF981F, true, true, -1, 1);
		setBounds(29040, 193, 283, 6, widget);


		addHoverButtonWSpriteLoader(29041, 1236, 100, 32, "Check Rewards", 0, 29042, 1);
		setBounds(29041, 256,274, 7, widget);
		addHoveredImageWSpriteLoader(29042, 1237, 100, 32, 29042 + 1);
		setBounds(29042, 256,274, 8, widget);
		...
		setBounds(29047, 256, 35, 11, widget);

	}
	public static void slotRewards(TextDrawingArea[] tda) {
		final RSInterface widget = addTabInterface(29050);
		setChildren(6, widget);

		addSpriteLoader(29051,1252);
		setBounds(29051, 68, 8, 0, widget);

		addText(29052, "Slot Rewards", 0xFF981F, true, true, -1, 2);
		setBounds(29052, 256, 13, 1, widget);


		addHoverButtonWSpriteLoader(29054, 1236, 100, 32, "Roll", 0, 29055, 1);
		setBounds(29054, 143+60, 274, 2, widget);

		addHoveredImageWSpriteLoader(29055, 1237, 100, 32, 29055 + 1);
		setBounds(29055, 143+60, 274, 3, widget);


		addText(29059,"Roll", 0xFF981F, true, true, -1, 1);
		setBounds(29059, 193+60, 283, 4, widget);

		setBounds(29070, 108, 69, 5, widget);


		final RSInterface container = addTabInterface(29070);
		setChildren(6, container);



		addText(29060,"@cya@Tier 1 Rewards!", 0xFF981F, true, true, -1, 1);
		setBounds(29060, 145, 5, 0, container);

		addToItemGroup(29071, 5, 5, 15, 8, false, null, null, null);
		setBounds(29071, 24, 30, 1, container);

		addText(29061,"@gr1@Tier 2 Rewards!", 0xFF981F, true, true, -1, 1);
		setBounds(29061, 145, 230, 2, container);

		addToItemGroup(29072, 5, 5, 15, 8, false, null, null, null);
		setBounds(29072, 24, 255, 3, container);


		addText(29062,"@mag@Tier 3 Rewards!", 0xFF981F, true, true, -1, 1);
		setBounds(29062, 145, 455, 4, container);

		addToItemGroup(29073, 5, 5, 15, 8, false, null, null, null);
		setBounds(29073, 24, 485, 5, container);




		container.scrollMax = 700;
		container.height = 200;
		container.width = 277;
	}

	public static void upgrading(TextDrawingArea[] tda) {
		final RSInterface widget = addTabInterface(29000);
		final RSInterface container = addTabInterface(29020);

		setChildren(16, widget);
		setChildren(1, container);

		addSpriteLoader(29001,1242);
		setBounds(29001, 7, 8, 0, widget);

		addText(29002, "Upgrading", 0xFF981F, true, true, -1, 2);
		setBounds(29002, 256, 13, 1, widget);

		setBounds(37603, 479, 11, 2, widget);
		setBounds(37604, 479, 11, 3, widget);

		addText(29003, "Select item to upgrade", 0xFF981F, true, true, -1, 2);
		setBounds(29003, 145, 64, 4, widget);
		addText(29004, "Upgraded Item", 0xFF981F, true, true, -1, 2);
		setBounds(29004, 379, 64, 5, widget);

		addText(29005, "Required for upgrade", 0xFF981F, true, true, -1, 2);
		setBounds(29005, 379, 138, 6, widget);
		addText(29006, "@gr1@Success rate: @whi@45%" , 0xc0ff00, true, true, -1, 1);
		...
		setBounds(29009, 330,221, 10, widget);
		addHoveredImageWSpriteLoader(29010, 1237, 100, 32, 29010 + 1);
		setBounds(29010, 330,221, 11, widget);

		addText(29012,"Upgrade", 0xFF981F, true, true, -1, 1);
		setBounds(29012, 382, 229, 12, widget);


		addToItemGroup(29013, 4, 1, 14, 8, true, "Select", null, null);
		setBounds(29013, 280, 180, 13, widget);

		addItemOnInterface(29014, 28999,  new String[]{});
		setBounds(29014, 350, 95, 14, widget);

		setBounds(29020, 50, 89, 15, widget);


		container.width = 187;
		container.height = 158;
		container.scrollMax = 880;

		addToItemGroup(29021, 4, 30, 14, 8, true, "Select", null, null);
		setBounds(29021, 10, 5, 0, container);
	...
	private static void dropTableCheckerInterface(TextDrawingArea[] rsFont) {
		...
		addHoverButtonWSpriteLoader(37605, 1236, 100, 32, "Search", 0, 37606, 1);
		setBounds(37605, 25,40, 4, main_widget);
		addHoveredImageWSpriteLoader(37606, 1237, 100, 32, 36706 + 1);
		setBounds(37606, 25,40, 5, main_widget);

		addHoverButtonWSpriteLoader(37608, 1236, 100, 32, "Search", 0, 37609, 1);
		setBounds(37608, 25,68, 6, main_widget);
		addHoveredImageWSpriteLoader(37609, 1237, 100, 32, 36709 + 1);
		setBounds(37609, 25,68, 7, main_widget);

		addSpriteLoader(37610, 1238);
		...
		addSpriteLoader(38553, 1240);
		addSpriteLoader(38554, 1241);
	...
	public static void invention(TextDrawingArea[] tda) {
		RSInterface rsint = addInterface(32000);

		addSpriteLoader(32001, 1221);


		addHoverButtonWSpriteLoader(32002, 1015, 16, 16, "Close Window", 0, 32003, 1);
		addHoveredImageWSpriteLoader(32003, 1016, 16, 16, 32004);


		addHoverButtonWSpriteLoader(32005, 1222, 35, 27, "Dismantle All", -1, 32006, 1);
		addHoveredImageWSpriteLoader(32006, 1223, 35, 27, 32007);

		addText(32008, "This is a line explaining what", tda, 0, 0xFFA500, true, true);
		addText(32009, "Invention is and how to use it", tda, 0, 0xFFA500, true, true);
		addText(32010, "Pretty simple really, this is", tda, 0, 0xFFA500, true, true);
		addText(32011, "Just place holder text.", tda, 0, 0xFFA500, true, true);

		rsint.totalChildren(9);
		rsint.child(0, 32001,29, 33);
		rsint.child(1, 32002, 455, 36);
		rsint.child(2, 32003, 455, 36);
		rsint.child(3, 32005, 278, 210);
		rsint.child(4, 32006, 278, 210);

		rsint.child(5, 32008, 378, 66);
		rsint.child(6, 32009, 378, 80);
		rsint.child(7, 32010, 378, 94);
		rsint.child(8, 32011, 378, 108);
	...
	public static void mysteryBox(TextDrawingArea[] tda) {
		...
		tab.child(c++, id++, 150 + x, 3 + y);

		tab.child(c++, 47300, 28 + x, 64 + y);

		addText(id, "Possible loot", tda, 1, 0xFFA500, true, true);
		tab.child(c++, id++, 150 + x, 40 + y);
		...
		id++;
		addHoverButtonWSpriteLoader(id, 1231, 87, 23, "Open", 0, id + 1, 1);
		tab.child(c++, id++, 50 + x, 187 + y);
		addHoveredImageWSpriteLoader(id, 1232, 87, 23, id + 1);
		tab.child(c++, id++, 50 + x, 187 + y);

		id++;
		addText(id, "Open", tda, 2, 0xFFA500, true, true);
		tab.child(c++, id++, 93 + x, 190 + y);

		id++;

		addHoverButtonWSpriteLoader(id, 1231, 87, 23, "Open all", 0, id + 1, 1);
		tab.child(c++, id++, 170 + x, 187 + y);
		addHoveredImageWSpriteLoader(id, 1232, 87, 23, id + 1);
		tab.child(c++, id++, 170 + x, 187 + y);

		id++;
		addText(id, "Open All", tda, 2, 0xFFA500, true, true);
		tab.child(c++, id++, 213 + x, 190 + y);

		id++;
		addHoverButtonWSpriteLoader(id, 1015, 16, 16, "Close Window", 0, id + 1, 1);
		tab.child(c++, id++, 379, 3 + y);
	...
	public static void starterTaskInterface(TextDrawingArea[] tda) {
		...
		addButtonWSpriteLoader(53229, 865, "@cya@Claim @yel@Rewards");
		...
		main.child(13, 53229, 38, 280); // button claim reward
	...
	public static void addToggleButton2(int id, int[] same, int sprite, int onSprite, String tooltip, boolean on) {
		...
		tab.atActionType = 1;
		tab.contentType = 0;
		tab.sprite1 = Client.spriteCache.get(sprite);
		tab.sprite2 = Client.spriteCache.get(onSprite);
...
*/
	...
	public static void skillTabInterface2() {
		...
		int[] buttons = { 8654, 8655, 8656, 8657, 8658, 8659, 8660, 8861, 8662, 8663, 8664, 8665, 8666, 8667, 8668, 8669, 8670, 8671, 8672, 12162, 13928, 28177, 28178, 28179, 28180, 28181};
		int[] hovers = { 4040, 4076, 4112, 4046, 4082, 4118, 4052, 4088, 4124, 4058, 4094, 4130, 4064, 4100, 4136, 4070, 4106, 4142, 4160, 2832, 13917, 28173, 28174, 28175, 28176, 28182 };
		...
		int[][] textCoords = { { 29, 7, 44, 19 }, { 91, 7, 106, 19 },
				...
				{ 29, 231, 44, 243 }, {91, 231, 106, 243}};
		int[][] newText = { { 28165, 28166, 28167, 28168 },
				{ 28169, 28170, 28171, 28172 }/*, {28186, 28187} */};
		int[] spriteIds = { 755, 766, 769, 775, 754, 774, 759, 765, 763, 771, 777, 757, 770, 758, 762, 768, 764, 778, 772, 773, 761, 756, 767, 776, 760, 1220};
		int frame = 0;
		...
		addText(31199, "Total", 0xFFEE33, false, true, 52, fonts, 0);
		addText(31200, "2475", 0xFFEE33, false, true, 52, fonts, 0);




		//addSpriteLoaderButtonWithTooltipBox(32100, 1219, "View @or2@Invention @lre@Options", 268, 32101, "Invention: 1/1\nCurrent XP: 14000000\nNext Level: 14000000\nRemainder: 14000000", 0, 30);
		//addText(32103, "99", 0xFFEE33, false, true, 52, fonts, 0);
		//addText(32104, "99", 0xFFEE33, false, true, 52, fonts, 0);
		//RSInterface.interfaceCache[32101].contentType = 1016;




		totalLevel.totalChildren(4);
		totalLevel.child(0, 31196, 127, 229);
		totalLevel.child(1, 31199, 106 + 27 + 25, 231);
		totalLevel.child(2, 31200, 117 + 27 + 15, 243);
		totalLevel.child(3, 31192, 38, 230);


		//totalLevel.child(4, 32100, 65, 229);
		//totalLevel.child(5, 32101, 65, 125);
		//totalLevel.child(6, 32103, 92, 230);
		//totalLevel.child(7, 32104, 104, 242);
	...
	public static void skillTabInterface3() {
		RSInterface skill = addTabInterface(3917);
		addSpriteLoader(28100, 753);
		skill.totalChildren(1);
		skill.child(0, 28100, 72, 237);
		...
		int[] buttons = { 8654, 8655, 8656, 8657, 8658, 8659, 8660, 8861, 8662, 8663, 8664, 8665, 8666, 8667, 8668, 8669, 8670, 8671, 8672, 12162, 13928, 28177, 28178, 28179, 28180, 32155 };
		int[] hovers = { 4040, 4076, 4112, 4046, 4082, 4118, 4052, 4088, 4124, 4058, 4094, 4130, 4064, 4100, 4136, 4070, 4106, 4142, 4160, 2832, 13917, 28173, 28174, 28175, 28176, 32150 };
		int[][] text = { { 4004, 4005 }, { 4016, 4017 }, { 4028, 4029 },
				{ 4006, 4007 }, { 4018, 4019 }, { 4030, 4031 }, { 4008, 4009 },
				{ 4020, 4021 }, { 4032, 4033 }, { 4010, 4011 }, { 4022, 4023 },
				{ 4034, 4035 }, { 4012, 4013 }, { 4024, 4025 }, { 4036, 4037 },
		...
		int[] icons = { 3965, 3966, 3967, 3968, 3969, 3970, 3971, 3972, 3973,
				3974, 3975, 3976, 3977, 3978, 3979, 3980, 3981, 3982, 4151,
				12165, 13925, 28181, 28182, 28183, 28184, 32158 };
		...
		addSkillText(32162, false, 25);
		addSkillText(32165, true, 25);
		skill.children(icons.length + (text.length * 2) + hovers.length + buttons.length * 5 + 3);
		...
		skill.child(frame, 32162, 91, 231);
		frame++;
		skill.child(frame, 32165, 106, 243);
		frame++;
	}
	...
	public static void dropPreview(TextDrawingArea[] tda) {
		...
		addText(47928, "Upgrade x2", 0xff9933, true, true, -1, tda, 2);
	...
	public static void addPrayerWithTooltipSpriteLoader(int i, int configId,
		...
		Interface.contentType = 0;
		Interface.opacity = 0;
		Interface.disabledSprite = Client.spriteCache.get(spriteOn);
		if(spriteOff != -1)
			Interface.enabledSprite = Client.spriteCache.get(spriteOff);
		Interface.width = 34;
		Interface.height = 34;
		Interface.valueCompareType = new int[1];
		Interface.requiredValues = new int[1];
	...
	public static void addPrayer(int i, int configId, int configFrame, int requiredValues, int spriteOn, int spriteOff, String tooltip) {
		...
		tab.opacity = 0;
		tab.hoverType = -1;
		tab.disabledSprite = Client.spriteCache.get(941);
		...
		tab2.opacity = 0;
		tab2.hoverType = -1;
		tab2.disabledSprite = Client.spriteCache.get(spriteOn);
		if(spriteOff != -1)
			tab2.enabledSprite = Client.spriteCache.get(spriteOff);
		tab2.width = 34;
		tab2.height = 34;
	...
	public static void addButtonWSpriteLoader(int id, int spriteId, int spriteId2, String tooltip) {
		...
		tab.opacity = (byte) 0;
		tab.hoverType = 52;
		tab.disabledSprite = Client.spriteCache.get(spriteId2);
		tab.enabledSprite = Client.spriteCache.get(spriteId);
		tab.width = tab.disabledSprite.myWidth;
		tab.height = tab.enabledSprite.myHeight - 2;
		tab.tooltip = tooltip;
	...
	public static void addHoverWSpriteLoader(int i, int spriteId, int width, int height, String text, int contentType,
		...
		tab.hoverType = hoverOver;
		tab.advancedSprite = true;
		tab.disabledSprite = spriteId > 0 ? Client.spriteCache.get(spriteId) : null;
		tab.enabledSprite = spriteId > 0 ? Client.spriteCache.get(spriteId) : null;
		tab.width = width;
		tab.height = height;
		tab.tooltip = text;
	}
	...
	public static void lunarSpellbookInterface() {
		...
		addTooltip(11012, "Shops Teleport.");
	...
	public static Sprite imageLoader(int i, String s) {
		...
		Sprite sprite = (Sprite) spriteCache.get((int) l);
		if (sprite != null)
			return sprite;
		try {
			sprite = new Sprite(s + " " + i);
