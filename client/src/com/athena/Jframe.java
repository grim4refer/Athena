...
public class Jframe extends Client implements ActionListener {
	...
	public void initUI(int width, int height, boolean resizable) {
		try {
		    ...
		    public void windowClosing(WindowEvent we) { 
		        ...
		        int userPrompt = JOptionPane.showOptionDialog(null, "Are you sure you wish to exit?", "LiquidX",
	...
	public void initializeMenuBar() {
		 ...
		 * Create our buttons
		 */
		JButton homeButton = createButton("Home", "House_icon.png", "Open the official LiquidX homepage.");
		JButton forumsButton = createButton("Forum", "forums.png", "Open the official LiquidX forums.");

		JButton knowledgeBaseButton = createButton("Knowledge Base", "3366503.gif", "Open the LiquidX Knowledge Base on the forums.");
		JButton storeButton = createButton("Store", "cart_icon.gif", "Open the official LiquidX store.");
		JButton voteButton = createButton("Vote", "Small-checkmark.png", "Open the official LiquidX voting page.");
		JButton scoresButton = createButton("HiScores", "hiscores.png", "Open the official LiquidX Hiscores");

		JButton tsButton = createButton("Join Discord", "discord.png", "Join the LiquidX discord.");
	...
	public void actionPerformed(ActionEvent evt) {
		...
		try {
			if (cmd != null) {
				switch (cmd) {
				case "Home":
					openURL("http://www.LiquidX.net");
					break;
				case "Forum":
					openURL("http://www.LiquidX.net/forums");
					break;
				case "Knowledge Base":
					openURL("http://LiquidX.net/forums/index.php?board=17.0");
					break;
				case "Store":
					openURL("http://LiquidX.net/Donate");
					break;
				case "Vote":
					openURL("http://LiquidX.everythingrs.com/services/vote");
					break;
				case "HiScores":
					openURL("http://LiquidX.everythingrs.com/services/hiscores");
					break;
				case "Join Discord":
