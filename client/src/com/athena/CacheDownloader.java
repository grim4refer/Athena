...
public class CacheDownloader implements Runnable {
	...
	*/
	...
	private static final String CACHE_PATH = System.getProperty("user.home") + File.separator + "LiquidXCache" + File.separator;
	private static final String ZIP_URL = "https://dl.dropbox.com/s/av6wbuxc4od8ktz/LiquidXCache.zip"; // Okkk ty i gtg now
	private static final String VERSION_FILE = CACHE_PATH + "cache_version.txt";
	private static final int CACHE_VERSION = 27;
	...
	private void unZipFile(File zipFile, File outFile) throws IOException {
		g.setStatus("Unzipping LiquidXCache...");
		g.setPercent(0);
	...
	private File downloadCache() {
		g.setStatus("Downloading LiquidXCache...");

		File ret = new File(CACHE_PATH + "liquidX.zip");
