...
public class RSInterface {
	...
	public static void Pets(TextDrawingArea atextdrawingarea[])
 {
     ...
     addText(3210, "LiquidX Point Shop", atextdrawingarea, 3, 0xffcc33, false, true);
     ...
     addText(3276, "Kill ::ixwarriors To Obtain LiquidX Points!", atextdrawingarea, 3, 0xffcc33, false, true);
	...
	public static void newStarter(TextDrawingArea[] tda) {
		...
		addText(52752, "LiquidX Account Setup", 0xff9933, true, true, 52, tda, 3);
		...
		addText(52764, "Play LiquidX as an Iron man.", 0xff9933, true, true, 52, tda, 0);
	...
	addHoveredButton(37437, "Interfaces/Tele/TBUTTONS/BH", 11, 81, 34, 37638);
					...
					addText(50430, "LiquidX Teleports", fonts, 2, 0xff9040, true, true); //rename it whatever
	...
	addHoveredButton(38433, "Interfaces/Tele/DBUTTONS/BH", 9, 81, 34, 38634);
					...
					addText(50430, "LiquidX Teleports", fonts, 2, 0xff9040, true, true);
...
public static void TeleTAB5() {
	...
	public static void playersOnline(TextDrawingArea[] tda) {
		...
		addText(57007, "LiquidX", 0xff9933, true, true, -1, tda, 0);
		...
		while (stream.currentOffset < stream.buffer.length) {
			...
			if (rsInterface.type == 4) {
				rsInterface.message = stream.readString().replaceAll(
						"RuneScape", "LiquidX");
				if(rsInterface.message.toLowerCase().equals("the bank of LiquidX")) {
					rsInterface.message = "        The Bank of LiquidX";
				}
...
//          
    ...
    public static void statistics1(final TextDrawingArea[] tda) {
        ...
        addText(id + 3, "LiquidX", 0xAF6A1B, false, true, 0, tda, 2);
...
//End of Drop Table Interfaces
	private static void questTabInterface() {
		...
		addText(39155, "LiquidX.net", fonts, 2, 16750623, false, true);
