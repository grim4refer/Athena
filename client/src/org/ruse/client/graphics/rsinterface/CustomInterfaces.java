package org.ruse.client.graphics.rsinterface;
...
public class CustomInterfaces extends RSInterface {
	...
	private void playerPanel() {
		...
		for(int i = 39159; i < 39214; i++) {
			...
			} else if(i == 39201 || i == 39202) {
				addClickableText(i, "", "Open Quest Log", tda, 1, 0xff0000, 167, 13);
			} else if(i == 39192 || i ==39193 || i >= 39205 && i <= 39210) {
	...
	private void playersOnline() {
		...
		addText(57007, "Www.RusePs.Com", 0xff9933, true, true, -1, tda, 0);
