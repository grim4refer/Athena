...
import org.ruse.client.accounts.Account;
import org.ruse.client.accounts.AccountManager;
import org.ruse.client.cache.Archive;
import org.ruse.client.cache.definition.Animation;
import org.ruse.client.cache.definition.Flo;
import org.ruse.client.cache.definition.IdentityKit;
import org.ruse.client.cache.definition.ItemDefinition;
import org.ruse.client.cache.definition.MobDefinition;
import org.ruse.client.cache.definition.ObjectDefinition;
import org.ruse.client.cache.definition.OverLayFlo317;
import org.ruse.client.cache.definition.SpotAnimDefinition;
import org.ruse.client.cache.definition.VarBit;
import org.ruse.client.cache.definition.Varp;
import org.ruse.client.cache.node.Deque;
import org.ruse.client.cache.node.Node;
import org.ruse.client.cache.ondemand.OnDemandFetcher;
import org.ruse.client.cache.ondemand.OnDemandRequest;
import org.ruse.client.constants.GameFrameConstants;
import org.ruse.client.constants.SizeConstants;
import org.ruse.client.constants.GameFrameConstants.GameFrameType;
import org.ruse.client.entity.player.Player;
import org.ruse.client.entity.player.PlayerHandler;
import org.ruse.client.graphics.Background;
import org.ruse.client.graphics.CursorData;
import org.ruse.client.graphics.DrawingArea;
import org.ruse.client.graphics.RSImageProducer;
import org.ruse.client.graphics.Sprite;
import org.ruse.client.graphics.SpriteLoader;
import org.ruse.client.graphics.fonts.Censor;
import org.ruse.client.graphics.fonts.RSFontSystem;
import org.ruse.client.graphics.fonts.TextClass;
import org.ruse.client.graphics.fonts.TextDrawingArea;
import org.ruse.client.graphics.fonts.TextInput;
import org.ruse.client.graphics.gameframe.GameFrame;
import org.ruse.client.graphics.gameframe.GameFrame.ScreenMode;
import org.ruse.client.graphics.gameframe.impl.ChatArea;
import org.ruse.client.graphics.gameframe.impl.MapArea;
import org.ruse.client.graphics.gameframe.impl.TabArea;
import org.ruse.client.graphics.rsinterface.DamageDealer;
import org.ruse.client.graphics.rsinterface.GrandExchange;
import org.ruse.client.graphics.rsinterface.MagicInterfaceData;
import org.ruse.client.graphics.rsinterface.PetSystem;
import org.ruse.client.io.ByteBuffer;
import org.ruse.client.io.ISAACCipher;
import org.ruse.client.net.Connection;
import org.ruse.client.net.HttpDownloadUtility;
import org.ruse.client.renderable.Animable;
import org.ruse.client.renderable.Animable_Sub3;
import org.ruse.client.renderable.Animable_Sub5;
import org.ruse.client.renderable.Entity;
import org.ruse.client.renderable.Item;
import org.ruse.client.renderable.NPC;
import org.ruse.client.renderable.PlayerProjectile;
import org.ruse.client.tools.FileUtilities;
import org.ruse.client.world.CollisionMap;
import org.ruse.client.world.CustomObjects;
import org.ruse.client.world.Model;
import org.ruse.client.world.Object1;
import org.ruse.client.world.Object2;
import org.ruse.client.world.Object3;
import org.ruse.client.world.Object5;
import org.ruse.client.world.ObjectManager;
import org.ruse.client.world.Rasterizer;
import org.ruse.client.world.Texture;
import org.ruse.client.world.WorldController;
import org.ruse.client.world.background.ScriptManager;
import org.ruse.client.world.music.Class56;
import org.ruse.client.world.music.Class56_Sub1_Sub1;
import org.ruse.client.world.sound.Class25;
import org.ruse.client.world.sound.Class3_Sub7;
import org.ruse.client.world.sound.Class3_Sub7_Sub1;
import org.ruse.client.world.sound.Class3_Sub7_Sub2;
import org.ruse.client.world.sound.Class3_Sub9_Sub1;
import org.ruse.client.world.sound.Class5;
import org.ruse.client.world.sound.Class5_Sub1;
import org.ruse.client.world.sound.Class5_Sub2;
import org.ruse.client.world.sound.Class5_Sub2_Sub1;
import org.ruse.client.world.sound.Class5_Sub2_Sub2;
import org.ruse.client.world.sound.Sound;
import org.ruse.client.world.sound.Sounds;
...
public class Client extends GameRenderer {
	...
	private void sendCommandPacket(String cmd) {
		...
		case "repack 1":
			repackCacheIndex(1);
			this.pushMessage("Repacked models", 0, null);
			//loadRegion();
			break;
		case "repack 2":
			repackCacheIndex(2);
			this.pushMessage("Repacked anims", 0, null);
			//loadRegion();
			break;
		case "repack 3":
			repackCacheIndex(3);
			this.pushMessage("Repacked maps", 0, null);
			//loadRegion();
			break;
		case "repack 4":
			repackCacheIndex(4);
			this.pushMessage("Repacked sounds", 0, null);
			//loadRegion();
			break;
		case "hitmarks":
	...
	private void buildAtPlayerMenu(int i, int j, Player player, int k) {
		...
		if(player.playerRights >= 5 && player.playerRights <= 9) {
			menuTooltip += "@yel@[$]@whi@ ";
		}
